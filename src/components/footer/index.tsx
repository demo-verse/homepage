...
const resources = [
  ...
  { name: 'Disruptive Quotes', link: 'https://xdai.unique.one/profile/demoverse' },
...
const contacts = [
  { name: 'Projection', link: 'https://trello.com/b/hUzyDssg/demoverse-a-journey-to-peace' },
        ...
        <div className={tw(`flex w-full `)}>
          <ul className={tw(` flex flex-wrap w-full lg:ml-12`)}>
            <li className={tw(`w-1/2 md:w-1/3 lg:w-1/3 `)}>
              <div>
                <h4 className={tw(`text-gray-900 text-xl lg:text-2xl font-bold mb-1`)}> @ web</h4>
                <ul>
            ...
            <li className={tw(`w-1/2 md:w-1/3 lg:w-1/3`)}>
              <div>
                <h4 className={tw(`text-gray-900 text-xl lg:text-2xl font-bold mb-1 `)}>Art of Peace</h4>
                <ul>
            ...
            <li className={tw(`w-1/2 md:w-1/3 lg:w-1/3 `)}>
              <div>
                <h4 className={tw(`text-gray-900 text-xl lg:text-2xl font-bold mb-1`)}>Concepts</h4>
                <ul>
                  {actions.map((action) => (
            ...
            <li>
              <div
                className={tw(
                  ` ml-20 lg:ml-0 lg:mr-12 mt-6 lg:mt-4 lg:my-2 text-center font-bolder  text-black lg:text-xl bg-green-500 rounded-full mr-8`,
                )}
              >
